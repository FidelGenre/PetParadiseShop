    ...
    <div className="relative w-full aspect-[3/2] rounded-3xl overflow-hidden shadow-2xl select-none">
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-white rounded-full shadow-2xl flex items-center justify-center ring-4 ring-white/30">
          <svg className="w-6 h-6 text-red-600" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" aria-hidden>
      ...
      <div className="absolute top-4 right-4 bg-red-600 text-white text-xs font-black uppercase tracking-widest px-3 py-1.5 rounded-full shadow-lg">
        {afterLabel}
      </div>
    </div>
  );
