      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-4 leading-tight">
            ¿Tu mascota merece <span className="underline decoration-white/40 decoration-4 underline-offset-4">más comodidad</span> en cada paseo?
          </h2>
          <p className="text-white/90 text-base md:text-lg">
            Descubrí por qué miles de dueños eligen nuestro kit premium para sus mejores amigos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-8 items-center">
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-2xl order-2 md:order-1">
            <h3 className="text-xl md:text-2xl font-black text-gray-900 mb-5 leading-tight text-center md:text-left">
              Los paseos no deberían ser un dolor de cabeza.
            </h3>
