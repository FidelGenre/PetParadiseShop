    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20" id="featured-products">
        ...
        <div className="text-center mt-10">
          <a
            href="/catalogo"
            className="inline-flex items-center gap-2 bg-gray-900 hover:bg-gray-800 text-white px-8 py-3.5 rounded-full font-bold text-sm transition-all duration-300 transform hover:scale-105 shadow-lg"
